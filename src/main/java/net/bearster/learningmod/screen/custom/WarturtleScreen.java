...
public class WarturtleScreen extends AbstractContainerScreen<WarturtleMenu> {
    private static final ResourceLocation GUI_TEXTURE_T0 =
            ResourceLocation.fromNamespaceAndPath(LearningMod.MOD_ID,"textures/entity/warturtle/gui/warturtle_gui_tier0.png");
    private static final ResourceLocation GUI_TEXTURE_T1 =
            ResourceLocation.fromNamespaceAndPath(LearningMod.MOD_ID,"textures/entity/warturtle/gui/warturtle_gui_tier1.png");
    private static final ResourceLocation GUI_TEXTURE_T2 =
            ResourceLocation.fromNamespaceAndPath(LearningMod.MOD_ID,"textures/entity/warturtle/gui/warturtle_gui_tier2.png");
    private static final ResourceLocation GUI_TEXTURE_T3 =
            ResourceLocation.fromNamespaceAndPath(LearningMod.MOD_ID,"textures/entity/warturtle/gui/warturtle_gui_tier3.png");
